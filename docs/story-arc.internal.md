# Crown & Concord — story arc (internal, spoiler-avoiding)
...
### Act I — The hall fills
**Intent:** teach the loop: read a room → trade words for leverage → choose a cost.

- Establish the three factions and the Greenmarch dispute.
- Offer early choices that define the envoy’s style (procedural / empathetic / transactional / forceful).
...
- The envoy’s choices accumulate debts that tighten future options.

**Gate:** the player must choose whether to prioritize stability, justice, or advantage.

### Act III — The Concord is tested
**Intent:** force the player to confront what legitimacy costs.

- The envoy becomes a target (politely): invitations that are traps, honors that are leashes.
- Negotiations stop being about Greenmarch and start being about who gets to define the Concord’s meaning going forward.

**Gate:** a second, larger convocation where one faction tries to rewrite the rules of recognition.

### Act IV — Settlement, not victory
**Intent:** endings should feel like governance.

- The best outcomes are durable, costly, and legible.
...
- Game: quiet intrigue, minimal melody, space for dialogue.
