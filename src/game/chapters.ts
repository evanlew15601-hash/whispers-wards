...
export const CHAPTERS: Record<string, ChapterDefinition> = {
  ...
  'chapter-15': {
    ...
    projectPoolId: 'projects:chapter-1',
    entryEffects: [{ kind: 'resource', resourceId: 'intel', delta: 1 }],
    exitConditions: [{ kind: 'milestone', id: 'chapter-15:resolved' }],
    exitToChapterId: 'chapter-16',
  },
  'chapter-16': {
    id: 'chapter-16',
    title: 'Chapter XVI — The Approval Loop',
    hubNodeId: 'chapter-16-hub',
    encounterPoolId: 'encounters:chapter-2',
    managementPoolId: 'management:chapter-1',
    projectPoolId: 'projects:chapter-1',
    entryEffects: [{ kind: 'resource', resourceId: 'intel', delta: 1 }],
    exitConditions: [{ kind: 'milestone', id: 'chapter-16:resolved' }],
    exitToChapterId: 'chapter-17',
  },
  'chapter-17': {
    id: 'chapter-17',
    title: 'Chapter XVII — The First Beneficiary',
    hubNodeId: 'chapter-17-hub',
    encounterPoolId: 'encounters:chapter-2',
    managementPoolId: 'management:chapter-1',
    projectPoolId: 'projects:chapter-1',
    entryEffects: [{ kind: 'resource', resourceId: 'intel', delta: 1 }],
    exitConditions: [{ kind: 'milestone', id: 'chapter-17:resolved' }],
    exitToChapterId: 'chapter-18',
  },
  'chapter-18': {
    id: 'chapter-18',
    title: 'Chapter XVIII — The Corridor’s Name',
    hubNodeId: 'chapter-18-hub',
    encounterPoolId: 'encounters:chapter-2',
    managementPoolId: 'management:chapter-1',
    projectPoolId: 'projects:chapter-1',
    entryEffects: [{ kind: 'resource', resourceId: 'influence', delta: 1 }],
    exitConditions: [],
