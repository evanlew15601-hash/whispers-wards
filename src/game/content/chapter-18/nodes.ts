...
You found the first recipient desk, and you decided what it would be allowed to do next.',
    choices: [
      ...
      },
      {
        ...
        text: 'Back to the dossier.',
        effects: [],
        nextNodeId: 'ch18-recap-la             ]    },

  'ch  'ch18-recap-ch13-witness    i    id: 'ch18-recap-ch13-witne    s    speaker: 'Field Not    t    text: 'You turned the first recipient into a witness prob
If thIf the desk receives a draft, it must also receive a ledger l
ConcoConcord survives by repetit
You fYou forced the repetition to be visibl    c    choice                     id: 'ch18-recap-ch13-witness-ba             text: 'Bac             effects:             nextNodeId: 'ch18-recap-ch             ]    },

  'ch  'ch18-recap-ch13-chain    i    id: 'ch18-recap-ch13-cha    s    speaker: 'Field Not    t    text: 'You turned the first recipient into an enforcement ch
Iron Iron does not care who is li
It caIt cares who is responsi
Now tNow the desk could not receive drafts without a rank that could be punished for what happened nex    c    choice                     id: 'ch18-recap-ch13-chain-ba             text: 'Bac             effects:             nextNodeId: 'ch18-recap-ch             ]    },

  'ch  'ch18-recap-ch13-marks    i    id: 'ch18-recap-ch13-mar    s    speaker: 'Field Not    t    text: 'You turned the first recipient into a tr
VerdaVerdant’s oldest fear is permanent harm dressed as convenie
You fYou forced the desk to carry marks that survived fil
The cThe corridor learned a new limitation: it could not claim nobody touched i    c    choice                     id: 'ch18-recap-ch13-marks-ba             text: 'Bac             effects:             nextNodeId: 'ch18-recap-ch             ]    },

  'ch  'ch18-recap-ch13-bond    i    id: 'ch18-recap-ch13-bo    s    speaker: 'Field Not    t    text: 'You turned the first recipient into liabil
EmberEmber does not fear instabil
It feIt fears instability nobody will pay 
Now tNow the desk could not move drafts without creating obligations somebody could collec    c    choice                     id: 'ch18-recap-ch13-bond-ba             text: 'Bac             effects:             nextNodeId: 'ch18-recap-ch             ]    },

  'ch  'ch18-recap-ch13-expose    i    id: 'ch18-recap-ch13-expo    s    speaker: 'Field Not    t    text: 'You exposed the d
A desA desk is just furnit
A desA desk that receives drafts first is pol
Once Once that can be said out loud, the corridor has to defend
DefenDefense is where mistakes happe    c    choice                     id: 'ch18-recap-ch13-expose-ba             text: 'Bac             effects:             nextNodeId: 'ch18-recap-ch             ]    },

  'ch  'ch18-recap-ch13-quiet    i    id: 'ch18-recap-ch13-qui    s    speaker: 'Field Not    t    text: 'You watc
The fThe first user of a corridor always reveals what it was built 
You dYou did not close the d
You lYou learned who reached for it when they needed an outcome without a signatur    c    choice                     id: 'ch18-recap-ch13-quiet-ba             text: 'Bac             effects:             nextNodeId: 'ch18-recap-ch             ]    },

  'ch  'ch18-recap-ch14    i    id: 'ch18-recap-ch    s    speaker: 'Field Not    t    text: 'The corridor chose its second addr
You dYou decided what kind of audience it would hav    c    choice                     id: 'ch18-recap-ch14-conco             text: 'You made the second address a Concord offic             effects:             requiresAllTokens: ['tok:ch14:outcome:concor             hideWhenLockedBySecrets: t             nextNodeId: 'ch18-recap-ch14-conco                              id: 'ch18-recap-ch14-ir             text: 'You made the second address answer to Iro             effects:             requiresAllTokens: ['tok:ch14:outcome:iro             hideWhenLockedBySecrets: t             nextNodeId: 'ch18-recap-ch14-ir                              id: 'ch18-recap-ch14-verda             text: 'You made the second address answer to Verdan             effects:             requiresAllTokens: ['tok:ch14:outcome:verdan             hideWhenLockedBySecrets: t             nextNodeId: 'ch18-recap-ch14-verda                              id: 'ch18-recap-ch14-emb             text: 'You made the second address answer to Embe             effects:             requiresAllTokens: ['tok:ch14:outcome:embe             hideWhenLockedBySecrets: t             nextNodeId: 'ch18-recap-ch14-emb                              id: 'ch18-recap-ch14-qui             text: 'You let the second address remain unseen, to learn its full rout             effects:             requiresAllTokens: ['tok:ch14:outcome:quie             hideWhenLockedBySecrets: t             nextNodeId: 'ch18-recap-ch14-qui                              id: 'ch18-recap-ch14-ba             text: 'Back to the dossie             effects:             nextNodeId: 'ch18-rec             ]    },

  'ch  'ch18-recap-ch14-concord    i    id: 'ch18-recap-ch14-conco    s    speaker: 'Field Not    t    text: 'You tried to make the corridor answer to a witnessable off
ConcoConcord’s foundation is precedent, not fo
You fYou forced the second address to become a place that could be pointed
It diIt did not end the corri
It maIt made it legibl    c    choice           {
